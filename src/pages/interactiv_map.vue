              ...
              <div v-if="show_greenfield == false">
                ...
                >
                  ...
                  <div class="items_greenfield" v-if="show_greenfield == false">
                    ...
                    <p
                      class="square_name__territory"
                      v-if="show_greenfield == false && oez_ppt.length != 0 && index == '11'"
                    >ОЭЗ «Липецк»</p>
                    <p
                      class="square_name__territory"
                    ...
                    <p
                      class="square_name__territory"
                      v-if="show_greenfield == false && oez.length && index == '9' "
                    >ОЭЗ РУ «Задонщина»</p>
                    <p
                      class="square_name__territory"
                      v-if="show_greenfield == false && oez.length && index == '7' "
                    >ОЭЗ РУ «Измалково»</p>
                    <p
                      class="square_name__territory"
                      v-if="show_greenfield == false && oez.length && index == '1' "
                    >ОЭЗ РУ «Астапово»</p>
                    <p
                      class="square_name__territory"
                      v-if="show_greenfield == false && oez.length && index == '13' "
                    >ОЭЗ РУ «Тербуны»</p>
                    <p
                      class="square_name__territory"
                      v-if="show_greenfield == false && oez.length && index == '8' "
                    >ОЭЗ РУ «Елец»</p>
                    <p
                      class="square_name__territory"
                      v-if="show_greenfield == false && oez.length && index == '14' "
                    >ОЭЗ РУ «Хлевное»</p>
                    <p
                      class="square_name__territory"
                      v-if="show_greenfield == false && oez.length && index == '2' "
                    >ОЭЗ РУ «Чаплыгинская»</p>
                    <div class="green">
                      <div
                        class="greenfield_border"
                        v-for="item in oez"
